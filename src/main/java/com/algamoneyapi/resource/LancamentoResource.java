...
import com.algamoneyapi.dto.Anexo;
...
public class LancamentoResource {
	...
	public ResponseEntity<Lancamento> buscarPeloCodigo(@PathVariable Long codigo, HttpServletResponse response) {
		...
		Optional<Lancamento> codigoLancamento = this.lancamentoRepository.findById(codigo);
		
		return codigoLancamento.isPresent() ? ResponseEntity.ok(codigoLancamento.get()) 
	...
	public ResponseEntity<byte[]> relatorioPorPessoa(
			@RequestParam String inicio, @RequestParam String fim) throws Exception {
